...
function CountryInfoPopup({ 
  ...
  useEffect(() => {
    if (isOpen && country && !isLoadingCountry && !population.accuratePopulation) {
  ...
  }, [isOpen, country?.cca2, isLoadingCountry]);
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-2xl shadow-2xl p-8">
            <div className="flex flex-col items-center space-y-4">
              ...
              <p className="text-gray-700 font-medium">Loading country information...</p>
            </div>
          </div>
        </div>
      </>
  ...
  return (
    <>
      ...
      {/* Popup Modal */}
      <div className="fixed inset-0 z-50 flex items-center justify-center px-3 py-4 sm:p-4">
        <div className="bg-white rounded-2xl shadow-2xl w-full max-w-full sm:max-w-lg max-h-[90vh]">
          
          {/* Header */}
          <div className={`sticky top-0 text-white px-4 py-5 sm:p-6 rounded-t-2xl flex justify-between items-start gap-3 transition-shadow duration-200 ${scrolled ? 'shadow-md' : ''}`} style={{background: 'linear-gradient(135deg, #1E3A8A, #2563EB)'}}>
            <div>
            ...
            <button
              onClick={onClose}
              className="p-2 hover:bg-white hover:bg-opacity-20 rounded-full transition-colors shrink-0"
              aria-label="Close"
            >
          ...
          {/* Content */}
          <div ref={contentRef} className="px-4 sm:px-6 py-5 sm:py-6 space-y-6 max-h-[80vh] overflow-y-auto bg-[#F7FAFC]">
              ...
              <div className="flex justify-center">
                <div className="relative w-40 h-28 sm:w-48 sm:h-32">
                  ...
                  <img
                    src={flag}
                    alt={`${name} flag`}
                    className={`w-48 h-32 object-cover rounded-lg shadow-lg border-2 transition-opacity duration-300 ${
            ...
            <div className="space-y-4">
              ...
              {/* Area */}
              <div className="flex items-start space-x-3 p-4 rounded-lg" style={{backgroundColor: '#E7F0FF'}}>
                <div className="flex-shrink-0 w-10 h-10 rounded-lg flex items-center justify-center" style={{backgroundColor: '#C7DBFF'}}>
                  <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" style={{color: '#2563EB'}}>
              ...
              {/* Population - Default */}
              <div className="flex items-start space-x-3 p-4 rounded-lg" style={{backgroundColor: '#E7FFF3'}}>
                <div className="flex-shrink-0 w-10 h-10 rounded-lg flex items-center justify-center" style={{backgroundColor: '#B3F2D1'}}>
                  <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" style={{color: '#0F9D58'}}>
                ...
                <div className="flex-1">
                  ...
                  {!showMoreDetails && (
                    <button
                      ...
                      className="text-xs mt-2 font-medium transition-colors" style={{color: '#D97706'}}
                    >
                      View accurate data →
                    </button>
                  )}
              ...
              {showMoreDetails && (
                <div className="flex items-start space-x-3 p-4 rounded-lg border-2" style={{backgroundColor: '#FFF9E6', borderColor: '#F59E0B'}}>
                  <div className="flex-shrink-0 w-10 h-10 rounded-lg flex items-center justify-center" style={{backgroundColor: '#F59E0B'}}>
                    <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" style={{color: '#FDE68A'}}>
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                    </svg>
                  </div>
                  <div className="flex-1">
                    <p className="text-sm font-medium text-gray-600">Accurate Population</p>
              ...
              {/* Languages */}
              <div className="flex items-start space-x-3 p-4 rounded-lg" style={{backgroundColor: '#EEF2FF'}}>
                <div className="flex-shrink-0 w-10 h-10 rounded-lg flex items-center justify-center" style={{backgroundColor: '#E0E7FF'}}>
                  <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" style={{color: '#4F46E5'}}>
              ...
              {/* Currency */}
              <div className="flex items-start space-x-3 p-4 rounded-lg" style={{backgroundColor: '#FFF4EC'}}>
                <div className="flex-shrink-0 w-10 h-10 rounded-lg flex items-center justify-center" style={{backgroundColor: '#FDBA74'}}>
                  <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" style={{color: '#C2410C'}}>
            ...
            {/* Fun Facts Section */}
            <div className="rounded-lg p-5 border-2" style={{background: 'linear-gradient(135deg, #E0E7FF, #F5F3FF)', borderColor: '#C7D2FE'}}>
              <div className="flex items-start justify-between gap-3">
                <div className="flex-1">
                  <p className="text-sm font-bold mb-2" style={{color: '#7C3AED'}}>DID YOU KNOW?</p>
                  ...
                  {facts.totalFacts > 1 && (
                    <button
                      ...
                      className="text-xs font-semibold mt-3 transition-colors" style={{color: '#7C3AED'}}
                    >
